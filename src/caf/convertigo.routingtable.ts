...
export class C8oRouteOptions{
  ...
  protected  _canEnter: C8oLifeCycleFunctionBoolean;
  ...
  /**
   * This function return canEnter function:
   *
   * @returns     The current canEnter function
   *
   */
  public get canEnter():C8oLifeCycleFunctionBoolean {
    return this._canEnter;
  }

  /**
   * This function set the canEnter function:
   *
   * @param canEnter	The canEnter function for this route
   * @returns             The instance of this Object
   *
   */
  public setCanEnter(canEnter: C8oLifeCycleFunctionBoolean) : C8oRouteOptions{
    this._canEnter = this.canEnter;
    return this;
  }
  ...
  /**
   * This function return canLeave function:
   *
   * @returns     The current canLeave function
   *
   */
  public get canLeave():C8oLifeCycleFunctionBoolean{
    return this._canLeave;
  }

  /**
   * This function set the canLeave function:
   *
   * @param canLeave	The canLeave function for this route
   * @returns             The instance of this Object
   *
   */
  public setcanLeave(canLeave: C8oLifeCycleFunctionBoolean) : C8oRouteOptions{
  ...
  public clone(c8oTableOptions : C8oRouteOptions){
      if(c8oTableOptions != undefined){
          ...
          this._canEnter = c8oTableOptions._canEnter;
          this._canLeave = c8oTableOptions._canLeave;
...
export class C8oTarget {
     ...
     *
     * @param navOptions	        The current alwaysNewPage parameters
     * @returns             The instance of this Object
     *
     */
 ...
 *
 */
export interface C8oLifeCycleFunctionBoolean {
  (page:C8oPage, c8o : C8o): boolean;
}
